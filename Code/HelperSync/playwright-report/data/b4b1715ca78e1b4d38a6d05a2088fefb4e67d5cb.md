...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Continue' })
    19 × locator resolved to <button class="flex-1 py-3.5 rounded-xl font-display font-semibold transition-all duration-200 bg-gray-900 text-white hover:bg-gray-800 shadow-sm hover:shadow-md">Continue</button>
